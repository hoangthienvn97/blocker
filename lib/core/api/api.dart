...
import 'package:phone_blocker/core/environment/base_url.dart';
...
class Api {
  ...
  static const String BaseApiUrl = "https://c61b44ccb1b3.ngrok.io/api/v1";
  ...
  Future<void> postCollected(int id,
      {Function(CollectionResponse) onSuccess, Function(ErrorResponse) onError}) async {
